...
const Dropdown = (props) => {
  ...
  // initialize a variable called divEl and make it our ref
  const divEl = useRef();
  ...
  */
  ...
  // useEffect(() => {}, []) // only runs ONCE when the components first mounts (is visible on the screen for the first time)
  // useEffect(() => {}) or useEffect(myFunction())// BAD: run everytime the component re-renders
